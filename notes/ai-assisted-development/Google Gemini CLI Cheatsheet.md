...
## [](https://www.philschmid.de/gemini-cli-cheatsheet#-getting-started)🚀 Getting Started

### [](https://www.philschmid.de/gemini-cli-cheatsheet#installation)Installation
...
### [](https://www.philschmid.de/gemini-cli-cheatsheet#authentication-with-a-gemini-api-key)Authentication with a Gemini API Key
...
### [](https://www.philschmid.de/gemini-cli-cheatsheet#basic-invocation)Basic Invocation
...
## [](https://www.philschmid.de/gemini-cli-cheatsheet#%EF%B8%8F-configuration)⚙️ Configuration

### [](https://www.philschmid.de/gemini-cli-cheatsheet#settings-files-settingsjson)Settings Files (`settings.json`)
...
### [](https://www.philschmid.de/gemini-cli-cheatsheet#context-files-geminimd)Context Files (`GEMINI.md`)
...
## [](https://www.philschmid.de/gemini-cli-cheatsheet#%EF%B8%8F-working-with-tools)🛠️ Working with Tools

### [](https://www.philschmid.de/gemini-cli-cheatsheet#some-built-in-tools)Some Built-in Tools
...
### [](https://www.philschmid.de/gemini-cli-cheatsheet#custom-tools-via-mcp-servers)Custom Tools via MCP Servers
...
## [](https://www.philschmid.de/gemini-cli-cheatsheet#-core-commands)⚡ Core Commands

### [](https://www.philschmid.de/gemini-cli-cheatsheet#helpful-slash-commands-)Helpful Slash Commands (`/`)
...
### [](https://www.philschmid.de/gemini-cli-cheatsheet#context-commands-)Context Commands (`@`)
...
### [](https://www.philschmid.de/gemini-cli-cheatsheet#shell-commands-)Shell Commands (`!`)
...
## [](https://www.philschmid.de/gemini-cli-cheatsheet#-advanced-features)✨ Advanced Features

### [](https://www.philschmid.de/gemini-cli-cheatsheet#custom-commands)Custom Commands
...
### [](https://www.philschmid.de/gemini-cli-cheatsheet#extensions)Extensions
...
### [](https://www.philschmid.de/gemini-cli-cheatsheet#checkpointing--restore)Checkpointing & Restore
