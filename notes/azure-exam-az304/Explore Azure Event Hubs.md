...
- [Introduction](https://learn.microsoft.com/en-us/training/modules/azure-event-hubs/1-introduction)3 min
    
- [Discover Azure Event Hubs](https://learn.microsoft.com/en-us/training/modules/azure-event-hubs/2-event-hubs-overview)3 min
    
- [Explore Event Hubs Capture](https://learn.microsoft.com/en-us/training/modules/azure-event-hubs/3-event-hubs-capture)3 min
    
- [Scale your processing application](https://learn.microsoft.com/en-us/training/modules/azure-event-hubs/4-event-processing)5 min
    
- [Control access to events](https://learn.microsoft.com/en-us/training/modules/azure-event-hubs/5-event-hubs-authentication-authorization)3 min
    
- [Perform common operations with the Event Hubs client library](https://learn.microsoft.com/en-us/training/modules/azure-event-hubs/6-event-hubs-programming-guide)5 min
    
- [Exercise - Send and retrieve events from Azure Event Hubs](https://learn.microsoft.com/en-us/training/modules/azure-event-hubs/6a-event-hubs-send-receive)30 min
    
- [Module assessment](https://learn.microsoft.com/en-us/training/modules/azure-event-hubs/7-knowledge-check)3 min
    
- [Summary](https://learn.microsoft.com/en-us/training/modules/azure-event-hubs/8-summary)3 min
